<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true" CodeBehind="InPatientSubmitList.aspx.cs" Inherits="InternalLims.Main.InPatientSubmitList" %>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    <div class="row">
                        <div class="col">
                            <h4 class="page-title">In Patient Test List</h4>
                            <ol class="breadcrumb">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="mb-3 row">
                                            <label for="example-text-input" class="col-sm-4 form-label">Barcode</label>
                                            <div class="col-sm-8">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="table-responsive">
                                <asp:GridView ID="PatientPaymentListGrid" Width="98%" HorizontalAlign="center" EmptyDataRowStyle-CssClass="alert custom-alert custom-alert-danger icon-custom-alert shadow-sm fade show d-flex justify-content-between" EmptyDataRowStyle-Font-Bold="true" EmptyDataRowStyle-Font-Size="14px" EmptyDataRowStyle-Font-Italic="true" CssClass="table table-hover mb-0" RowStyle-HorizontalAlign="Center" HeaderStyle-CssClass="thead-light" AllowPaging="true" PageSize="10" DataKeyNames="TestId" AllowSorting="true" EmptyDataText="No Records Found" AutoGenerateColumns="false" OnPageIndexChanging="PatientPaymentListGrid_PageIndexChanging" runat="server" OnRowCommand="PatientPaymentListGrid_RowCommand" GridLines="None" HeaderStyle-HorizontalAlign="Center">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="CreatedDt">
                                          ...
                                          <asp:TemplateField HeaderText="Submit NIPT">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="Submit_NIPT" runat="server" ImageUrl="~/assets/images/documents.png" CommandArgument='<%#Eval("TestId")%>' CommandName="SubmitNIPT" Font-Size="12px" ForeColor="White" Width="35" PostBackUrl='<%#Eval("Redirect")%>'></asp:ImageButton>
                                            </ItemTemplate>
                                            <ItemStyle Width="5%" />
                                        </asp:TemplateField>
                                           <asp:TemplateField HeaderText="Print Bill">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/assets/images/bill.png" CommandArgument='<%#Eval("PaymentId")%>' CommandName="PaymentId" Width="35" Font-Size="12px" ForeColor="White" target="_blank"></asp:ImageButton>
                                            </ItemTemplate>
                                            <ItemStyle Width="5%" />
                                        </asp:TemplateField>
