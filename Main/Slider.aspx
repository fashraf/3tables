<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Slider.aspx.cs" Inherits="InternalLims.Main.Slider" %>
    ...
    <div class="container">
        <div class="slider">
            ...
            <div class="box1 box">
                <div class="bg"></div>
                <div class="details">
                    <h1>Welcome To Novogenomics</h1>
                    <p>
                      BIOTECH Leader in Saudi DNA
                    </p>
            ...
            <div class="box2 box">
                ...
                <div class="details">
                    <h1>NIPT</h1>
                    <p>
                       NIPT is a screening test, which means that it will not give a definitive answer about whether or not a fetus has a genetic condition
                    </p>
                    <button>Check Now</button>
                </div>
            ...
            <div class="box3 box">
                <div class="bg"></div>
                <div class="details">
                    <h1>Whole Genome Sequencing</h1>
                    <p>
                    Whole genome sequencing, also known as full genome sequencing, complete genome sequencing, or entire genome sequencing, is the process of determining the entirety, or nearly the entirety, of the DNA sequence of an organism's genome at a single time.</p>
                </div>
